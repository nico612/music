//
//  AbstractFactoryRealWorld.swift
//  MusicTests
//
...
class StudentAuthViewFactory: AuthViewFactory {
    ...
    static func authView(for type: AuthType) -> AuthView {
        print("Student View hhas been created")
        switch type {
        case .login:
...
private class AbstractFactoryRealClientCode {
    
    private var currentController: AuthViewController?
    
    private lazy var navigationController: UINavigationController = {
        guard let vc = self.currentController else { return UINavigationController() }
...
final class AbstractFactoryRealWorld: XCTestCase {
...
#if teacherMode
        let clientCode = AbstractFactoryRealClientCode(factoryType: TeacherAuthViewFactory.self)
#else
        let clientCode = AbstractFactoryRealClientCode(factoryType: StudentAuthViewFactory.self)
#endif
